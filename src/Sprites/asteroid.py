...
from CONSTS.COLORS import COLOR_RED
from CONSTS.ASTEROIDS import ASTEROID_MIN_RADIUS
...
class Asteroid(CircleShape):
    ...
    def draw(self, screen):
        ...
        """
        pygame.draw.circle(
            screen, COLOR_RED, [self.position.x, self.position.y], self.radius, 2
        )
    ...
    def split(self):
        ...
        if self.radius <= small_asteroid:
            ...
            # Split off into two new asteroids with random rotations and velocities
